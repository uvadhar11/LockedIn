...
import { Trash2, Archive, CheckSquare, Square, Plus, X, Calendar, Paperclip, Check } from 'lucide-react';
...
export function InboxTab({ onAddTask }: InboxTabProps) {
  ...
  const updateItemType = (id: string, type: 'task' | 'project' | 'reference') => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)]">
      ...
      <div className="flex-1 flex">
        {/* Items List */}
        <div className={`${selectedItem ? 'w-1/2' : 'w-full'} overflow-auto p-6`}>
